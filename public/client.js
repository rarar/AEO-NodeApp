  ...
  if (PAX_SETTINGS.USE_PAX_SENSOR){
    socket.on('pax',function(pax){
      ...
      if (urbanizationLevel > 3 * URBANIZATION_THRESHOLD) {
        ...
        document.querySelector(".right .urbanization h2").classList.add("red");
      } else if (urbanizationLevel > 2 * URBANIZATION_THRESHOLD) {
        document.querySelector(".right .urbanization h2").classList.remove("red");
        document.querySelector(".right .urbanization h2").classList.remove("yellow");
        document.querySelector(".right .urbanization h2").classList.add("orange");
      } else if (urbanizationLevel > 1.5 * URBANIZATION_THRESHOLD) {
        document.querySelector(".right .urbanization h2").classList.remove("red");
        document.querySelector(".right .urbanization h2").classList.remove("orange");
        document.querySelector(".right .urbanization h2").classList.add("yellow");
      } else {
        document.querySelector(".right .urbanization h2").classList.remove("red");
        document.querySelector(".right .urbanization h2").classList.remove("orange");
        document.querySelector(".right .urbanization h2").classList.remove("yellow");
